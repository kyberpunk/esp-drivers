...
typedef struct spi_handle_data_tag* spi_handle;
typedef struct uart_handle_data_tag* uart_handle;
typedef struct pin_handle_data_tag* pin_handle;
...
void Metro_Set_Uart_Handle(METRO_NB_Device_t in_Metro_Device, uart_handle uart_handle);
void Metro_Set_Spi_Handle(METRO_NB_Device_t in_Metro_Device, spi_handle spi_handle);
void Metro_Set_Pin_Handle(METRO_NB_Device_t in_Metro_Device, pin_handle pin_handle);
